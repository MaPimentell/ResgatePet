                ...
                <div class="p-6 text-gray-900">
                    <div class="mb-14">
                        <div class="flex items-start justify-between md:mb-10">
                            ...
                            <button id="btnAdicionarAlerta"
                                class="flex gap-3 px-2 py-3 md:px-4 md:py-3 text-xs md:text-base font-semibold text-white border border-red-600 bg-red-600 hover:bg-transparent hover:text-red-600 rounded-lg transition ease-in-out duration-300">
                                Adicionar alerta
                                <svg class="icon  size-4 md:size-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke=""><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g clip-path="url(#ffffclip0_949_22799)"> <path class="icon" fill-rule="evenodd" clip-rule="evenodd" d="M9.82664 2.22902C10.7938 0.590326 13.2063 0.590325 14.1735 2.22902L23.6599 18.3024C24.6578 19.9933 23.3638 22 21.4865 22H2.51362C0.63634 22 -0.657696 19.9933 0.340215 18.3024L9.82664 2.22902ZM10.0586 7.05547C10.0268 6.48227 10.483 6 11.0571 6H12.9429C13.517 6 13.9732 6.48227 13.9414 7.05547L13.5525 14.0555C13.523 14.5854 13.0847 15 12.554 15H11.446C10.9153 15 10.477 14.5854 10.4475 14.0555L10.0586 7.05547ZM14 18C14 19.1046 13.1046 20 12 20C10.8954 20 10 19.1046 10 18C10 16.8954 10.8954 16 12 16C13.1046 16 14 16.8954 14 18Z" fill="#ffff"></path> </g> <defs> <clipPath id="clip0_949_22799"> <rect class="icon" width="24" height="24" fill="white"></rect> </clipPath> </defs> </g></svg>
                            </button>
                        </div>
                    ...
                    <div class="mb-12">
                        <div class="mb-8">
                            ...
                            <span class=" text-gray-600 font-medium">Se o seu animal fugiu de casa, mantenha a calma e siga as instruções abaixo:</span>
                        </div>
