                    ...
                    <div class="mb-14">
                        ...
                        <div class="md:flex mb-3">
                            ...
                            <div class="flex flex-col justify-start items-center md:px-3 md:w-1/3">
                                ...
                                <span class="md:text-base text-sm text-center text-gray-800">Na mesma página, em <i>Mapa</i>, clique no botão <i>Adicionar Alerta</i>, selecione o animal perdido e confirme. Após isso, um ícone de pata será gerado no mapa, indicando a localização de seu animal perdido.</span>                            </div>
                            <div class="flex items-center md:mb-0 mb-6">
