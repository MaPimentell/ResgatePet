                    ...
                    <div class="mb-14">
                        <div class="flex items-start justify-between md:mb-10">
                            ...
                            <button id="btnAdicionarAlerta"
                                class="flex gap-3 px-2 py-3 md:px-4 md:py-3 text-xs md:text-base font-semibold text-white border border-red-600 bg-red-600 hover:bg-transparent hover:text-red-600 rounded-lg ">
                                Adicionar alerta
