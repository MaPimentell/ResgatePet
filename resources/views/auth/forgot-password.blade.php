<x-guest-layout>
    ...
    <form method="POST" action="{{ route('password.email') }}">
        ...
        <div>
            ...
            <x-text-input placeholder="Digite seu email" id="email" class="block mt-1 w-full placeholder-slate-400 bg-slate-50" type="email" name="email" :value="old('email')" required  />
